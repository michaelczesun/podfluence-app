...
function injectStyles() {
  ...
  .pf-modal {
    ...
    max-width: 92vw; max-height: calc(100vh - 80px);
  ...
  .pf-modal-header {
    ...
    flex-shrink: 0;
    position: sticky; top: 0; background: #16161D; z-index: 2;
  }
  .pf-modal-close {
  ...
  .pf-modal-footer {
    ...
    flex-shrink: 0;
    position: sticky; bottom: 0; background: #16161D; z-index: 2;
  }
  @media (max-width: 560px) {
    .pf-overlay { padding: 0; }
    .pf-modal {
      width: 100% !important; max-width: 100vw;
      height: 100vh; max-height: 100vh;
      border-radius: 0; border-left: none; border-right: none;
    }
    .pf-modal-body { max-height: none; }
  }
  .pf-btn {
