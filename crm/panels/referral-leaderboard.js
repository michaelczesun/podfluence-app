...
async function grantBonusCode(inviterId) {
  ...
  try {
    ...
    toast('Fehler: ' + (e.message || e), { type: 'error' })
    return false
  }
}
...
export default {
  ...
  async mount(container) {
    ...
    container.querySelector('#btn-pdf').addEventListener('click', async () => {
      ...
      } catch (e) { toast('PDF fehlgeschlagen', { type: 'error' }) }
    })
