...
import { toast, fmtNumber, fmtDateTime, fmtRelativeTime, htmlEscape, iconHtml } from '/lib/ui.js?v=20260608p'
import { fadeIn, countUp } from '/lib/animations.js?v=20260608p'
import { glassCard, pullToRefresh } from '/lib/layout-extras.js?v=20260608p'

import adminHome from '/crm/panels/admin-home.js?v=20260608p'
import auditLog  from '/crm/panels/audit-log.js?v=20260608p'
