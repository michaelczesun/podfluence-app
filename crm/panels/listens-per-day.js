...
import { makeLineChart, makeHeatmap } from '/lib/charts.js?v=20260608k'
...
import { drawer, segmentedControl, statHero } from '/lib/layout-extras.js?v=20260608k'
    ...
    try {
      ...
      function render() {
        ...
        function drawLine() {
          ...
          // shape per /lib/charts.js?v=20260608k signature.
        ...
        // and the ApexCharts series shape that /lib/charts.js?v=20260608k expects:
