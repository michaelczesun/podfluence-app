...
import { toast, fmtNumber, htmlEscape, iconHtml, spinnerHtml } from '/lib/ui.js?v=20260608o'
import { makeLineChart, makeHeatmap } from '/lib/charts.js?v=20260608o'
...
import { drawer, segmentedControl, statHero } from '/lib/layout-extras.js?v=20260608o'
    ...
    try {
      ...
      function render() {
        ...
        function drawLine() {
          ...
          // shape per /lib/charts.js?v=20260608o signature.
        ...
        // and the ApexCharts series shape that /lib/charts.js?v=20260608o expects:
