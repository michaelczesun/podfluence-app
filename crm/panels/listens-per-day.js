...
import { toast, fmtNumber, htmlEscape, iconHtml, spinnerHtml } from '/lib/ui.js?v=20260608l'
import { makeLineChart, makeHeatmap } from '/lib/charts.js?v=20260608l'
    ...
    try {
      ...
      function render() {
        ...
        function drawLine() {
          ...
          // shape per /lib/charts.js?v=20260608l signature.
        ...
        // and the ApexCharts series shape that /lib/charts.js?v=20260608l expects:
